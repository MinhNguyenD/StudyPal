...
* *Project URL*: <https://study-pal.netlify.app/>
* *Git URL*: <https://git.cs.dal.ca/minh/csci4177grp-20/-/tree/main?ref_type=heads>
...
* [Lam Tieu](lm436150@dal.ca) - Owner
* [Minh Nguyen](lm436150@dal.ca) - Owner
* [Bhavya Ghevariya](B.Ghevariya@dal.ca) - Owner
* [Aryah Kannan](aryah@dal.ca) - Owner
...
* [Tailwind](https://tailwindcss.com/) - CSS library for front-end styling
* [Figma](https://www.figma.com/) - Design tool for task flow diagram and wireframe
* [Shadcn](https://www.shadcn-vue.com/) - UI component library to build accordion dropdown
* [Freepik](https://www.freepik.com/) - Illustration image on Landing Page
* [Canva](https://www.canva.com/) - Illustration image on Landing Page
* [Color/UI Inspiration](https://www.behance.net/gallery/176756171/Elearning-Education-Website-Landing-Page-Design?tracking_source=search_projects|Education+Website+Design&l=13)
...
* Vue router for routing to a different page: https://router.vuejs.org/guide/
