        ...
        <div class="flex w-full">
            <div class="flex space flex-row justify-between w-10/12 m-auto items-center">
                <div class="w-6/12">
                    ...
                    <h4 class="font-semibold mb-6">We'd love to hear from you! Drop us a <br />message and we'll get
                        back to
                        you
                        soon!</h4>
                ...
                <form class="flex flex-col bg-accent p-10 gap-4 rounded-2xl w-6/12 shadow-[0.75em_0.75em_lightgray]">
                    ...
                    <div>
                        ...
                        <textarea v-bind:class="errors.message ? 'border-error' : 'border-none'"
                            class="rounded-xl w-full" name="message" rows="8" v-model="message"></textarea>
                    </div>
                    <button class="text-white rounded-full bg-primary py-2 w-1/3" type="submit"
